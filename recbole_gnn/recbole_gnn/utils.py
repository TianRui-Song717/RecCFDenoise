...
from recbole_gnn.recbole_gnn.data.dataloader import CustomizedTrainDataLoader, CustomizedNegSampleEvalDataLoader, CustomizedFullSortEvalDataLoader
...
def create_dataset(config):
    ...
    dataset_module = importlib.import_module('recbole_gnn.recbole_gnn.data.dataset')
    gen_graph_module_path = '.'.join(['recbole_gnn.recbole_gnn.model.general_recommender', config['model'].lower()])
    seq_module_path = '.'.join(['recbole_gnn.recbole_gnn.model.sequential_recommender', config['model'].lower()])
...
def get_model(model_name):
    ...
    for submodule in model_submodule:
        module_path = '.'.join(['recbole_gnn.recbole_gnn.model', submodule, model_file_name])
...
def get_trainer(model_type, model_name):
    ...
    """
    try:
        return getattr(importlib.import_module('recbole_gnn.recbole_gnn.trainer'), model_name + 'Trainer')
