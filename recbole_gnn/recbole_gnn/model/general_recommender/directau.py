...
from recbole_gnn.recbole_gnn.model.general_recommender import LightGCN

from recbole_gnn.recbole_gnn.model.abstract_recommender import GeneralGraphRecommender
